<div>
 ...
 <div class="row">
    ...
    <thead>
    <tr role="row"><th class="sorting_asc" role="columnheader" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" style="width: 204px;" aria-sort="ascending" aria-label="Username: activate to sort column descending">Username</th>
        <th class="sorting" role="columnheader" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" style="width: 188px;" aria-label="Date registered: activate to sort column ascending">Date registered</th>
        <th class="sorting" role="columnheader" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" style="width: 93px;" aria-label="Role: activate to sort column ascending">Role</th>
    ...
    <tbody role="alert" aria-live="polite" aria-relevant="all">
        ...
        <td class="center "><?php echo h($add['description']); ?></td>
        <td class="center "><?php echo h($add['price']); ?></td>
        <td class="center ">
            <span class="label-default label label-danger"><?php  
        if($add['status']==1){
            $sts=0;
        $active='Aproved';   
        }if($add['status']==0){
