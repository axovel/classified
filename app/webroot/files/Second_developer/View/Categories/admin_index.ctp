<div>
 ...
 <div class="row">
	...
	<tr class="odd">
		...
		<td class="center">
			<?php echo $this->Html->link(__('View'),array('action' => 'admin_view', $category['Category']['id'])); ?>
			<?php echo $this->Html->link(__('Edit'),array('action' => 'admin_edit', $category['Category']['id'])); ?>
			<?php echo $this->Html->link(__('Delete'),array('action' => 'admin_delete', $category['Category']['id'])); ?>
