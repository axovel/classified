 ...
 <div class="row">
    ...
    <thead>
    <tr role="row"><th class="sorting_asc" role="columnheader" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" style="width: 204px;" aria-sort="ascending" aria-label="Username: activate to sort column descending">Category Name</th>
	...
	<tr class="odd">
		<td  class="center"><?php echo h($category['Category']['name']); ?>&nbsp;</td>
		<td  class="center">
                	  <?php  
        ...
        $active='Aproved';   
            ...
            $sts=1;
             $active='Disaproved'; 
                ...
                echo $this->Html->link(
                     $active,
                    array('action' => 'status', $category['Category']['id'],$sts)
                );
            ?> 
                </td>
                
        <td class="center ">
            <a href="<?php echo Configure::read('ROOT_DIRECTORY')?>/Categories/admin_view/<?php echo $category['Category']['id'];?>" class="btn btn-success">
                <i class="glyphicon glyphicon-zoom-in icon-white"></i>
                View
            </a>
            <a href="<?php echo Configure::read('ROOT_DIRECTORY')?>/Categories/admin_edit/<?php echo $category['Category']['id'];?>" class="btn btn-info">
                <i class="glyphicon glyphicon-edit icon-white"></i>
                Edit
            </a>
            <a href="<?php echo Configure::read('ROOT_DIRECTORY')?>/Categories/admin_delete/<?php echo $category['Category']['id'];?>" class="btn btn-danger">
